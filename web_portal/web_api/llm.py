...
async def get_summary_response(db: AsyncSession):
    ...
    response = openai_client.chat.completions.create(
        model="gpt-4o-mini",
        messages=[
            {"role": "system", "content": "You are a helpful assistant for a backyard weather station. Only use the provided data; do not say you lack real-time access. Provide some insight that a meteorologist would have, given the local climate. You can flag any data that seems unrealistic."},
